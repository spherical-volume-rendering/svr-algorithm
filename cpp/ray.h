...
struct Ray final {
    ...
    [[nodiscard]] inline constexpr BoundVec3 point_at_parameter(const double t) const {
    ...
    [[nodiscard]] inline constexpr UnitVec3 inv_direction() const { return this->inverse_direction_;}
private:
