...
static void BenchmarkTraversalOne() {
...
static void BenchmarkTraversalParallelY() {
...
static void BenchmarkTraversalParallelZ() {
...
static void BenchmarkTraversalParallelX() {
...
static void BenchmarkMultipleRayNoIntersection() {
    // 10,000x no ray entrance.
...
static void SphericalVoxelTraversal(benchmark::State& state) {
    for (auto _ : state) {
        BenchmarkTraversalOne();
        BenchmarkTraversalParallelY();
        BenchmarkTraversalParallelX();
        BenchmarkTraversalParallelZ();
        BenchmarkMultipleRayNoIntersection();
    }
}

BENCHMARK(SphericalVoxelTraversal)->Unit(benchmark::kMillisecond);
BENCHMARK_MAIN();
